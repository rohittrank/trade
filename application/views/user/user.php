                        ...
                        <form action="<?php echo base_url('user/search'); ?>" method="post" autocomplete="off">
                            <div class="flex flex-wrap">
                                <div class="form-group col-wd-33">
                                    ...
                                    <span id="searchError" class="error"><?php echo form_error('search'); ?></span>
                                </div>
                                ...
                                <div class="submit-btn">
                                    ...
                                    <a href="<?php echo base_url('user'); ?>" class="btn btn-primary">Reset</a>
                                </div>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="create-trades trade-table">
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo base_url('user/user_view/' . $data['user_id']); ?>"><i
                                            class="fa-solid fa-eye"></i></a>
                                    <span>
                                        <a href="<?php echo base_url('user/edit_user_view/' . $data['user_id']); ?>"><i
                                                class="fa-solid fa-pen"></i></a>
                                    </span>
                                    <span>
                                        <a href="<?php echo base_url('user/delete/' . $data['user_id']); ?>"
                                            onclick="confirmDelete(event, '<?php echo base_url('user/delete/' . $data['user_id']); ?>')"><i
                                   ...
                                   <a
                                        href="<?php echo base_url().'trading_clients/add_funds/'.$data['user_id']; ?>"><i
                                            class="fa-solid fa-arrow-up"></i></a>
                                    <a
                                        href="<?php echo base_url().'trading_clients/create_funds_withdrawal/'.$data['user_id']; ?>"><i
