                ...
                <div class="trade-cntent">
                    ...
                    <div class="create-trades trade-table">
                        <table>
                            ...
                            <?php $i = 1;
                            foreach ($get_all_clients as $clients)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span>
                                            <a href="<?php echo base_url('trading_clients/delete_user/' . $clients['user_id']); ?>" onclick="confirmDelete(event, '<?php echo base_url('trading_clients/delete/' . $clients['user_id']); ?>')"><i class="fa-solid fa-trash"></i></a>
                                        </span>
                                    ...
                                    <td><?php echo ($clients['demo_account'] == 'on') ? 'Yes' : 'No' ?></td>
