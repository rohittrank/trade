            ...
            <div class="dashboard-content">
                ...
                <div class="trade-cntent">
                    <div class="card-small-header" style="width: 22%;">
                        <h4 class="card-title" style="text-align: center;">Create Funds Withdrawal</h4>
                    </div>
                    ...
                    <div class="form">
                        <form id="myForm" action="<?php echo base_url('trading_clients/save_funds_withdrawal/'). $client_data['user_id']; ?>" method="POST" autocomplete="off">
                            <div class="flex flex-wrap">
                                <div class="form-group col-wd-50">
                                    <label>User Id</label>
                                    <div class="dropdown">
                                    <?php echo strtoupper(substr($client_data['name'], 0, 2)) . $client_data['id']; ?>&nbsp;(<?php echo $client_data['user_id'] ?>)
                                                    <input type="hidden" name="userid" id="userid" value="<?php echo $client_data['user_id'] ?>">
                                                </div>
                                </div>
                                <div class="form-group col-wd-50">
                                    <label>Notes</label>
                                ...
                                <div class="submit-btn">
                                    <input type="submit" class="btn btn-success" value="Save Funds Withdrawal">
                                </div>
                            </div>
                        </form>
                    </div>
